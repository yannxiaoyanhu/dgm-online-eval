# References:
# https://github.com/layer6ai-labs/dgm-eval/blob/master/dgm_eval/dataloaders.py
    ...
    def subsample_dataset(self):
        ...
        if self.random_sample:
            self.inds_keep = sorted(
                np.random.choice(len(self.data_set), self.nsample, replace=self.sample_w_replacement))
        else:
...
def get_dataloader(path, nsample=-1, batch_size=32, num_workers=1, transform=None, seed=13579, random_sample=True,
