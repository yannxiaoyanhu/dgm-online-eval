# References:
# https://github.com/layer6ai-labs/dgm-eval/blob/master/dgm_eval/models/inception.py
...
FID_WEIGHTS_URL = '../pretrained_models/pt_inception-2015-12-05-6726825d.pth'  # noqa: E501
...
def fid_inception_v3():
    ...
    inception.load_state_dict(torch.load(FID_WEIGHTS_URL, weights_only=True))
    return inception
