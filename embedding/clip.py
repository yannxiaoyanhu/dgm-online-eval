# References:
# https://github.com/layer6ai-labs/dgm-eval/blob/master/dgm_eval/models/clip.py
...
ARCH_WEIGHT_DEFAULTS = {
    ...
    'ViT-L-14': '../cache/hub/models--laion--CLIP-ViT-L-14-DataComp.XL-s13B-b90K/snapshots/'
...
class CLIPEncoder(Encoder):
    def setup(self, arch:bool=None, pretrained_weights:bool=None, clean_resize:bool=False, depth:int=0):
        ...
        self.model = open_clip.create_model(arch, pretrained=pretrained_weights)
    ...
    def forward(self, x: torch.Tensor):
        ...
        if False: #self.model.visual.global_average_pool:
            x = x.mean(dim=1)
        else:
            x = x[:, 0]
